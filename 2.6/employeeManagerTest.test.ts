import {Builder,By, Capabilities, until, WebDriver, } from "selenium-webdriver";
  ...
  class employeePage {
      ...
      url: string = "https://devmountain-qa.github.io/employee-manager/1.2_Version/index.html";
        ...
        newEmployee: By = By.name('newEmployee')
